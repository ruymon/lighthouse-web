...
export function NotFound() {
  return (
    <main className="w-full h-screen max-h-full overflow-hidden flex items-center justify-between">
      <img src={lostSailor} alt="Lost Sailor Illustration" className="-ml-48 grow overflow-hidden hidden md:flex" />

      <div className="h-full flex flex-col items-start gap-12 p-8 justify-center w-full md:w-[40%]">
